...
array1=("ICEBOX" "DEFINED" "IN PROGRESS" "IN REVIEW" "DONE" "EMERGENCY" "BLOCKED" "DEAD")
array2=("NEW" "OPEN" "IN PROGRESS" "CODE COMPLETE" "PENDING BUILD" "TEST READY" "TEST IN PROGRESS" "CLOSED" "WON'T FIX" "CAN'T REPRODUCE")
